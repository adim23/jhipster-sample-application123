...
import TeamsUpdateComponent from '@/entities/teams/teams-update.vue';
import TeamsClass from '@/entities/teams/teams-update.component';
...
describe('Component Tests', () => {
  describe('Teams Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TeamsClass>(TeamsUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.teams = entity;
        teamsServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(teamsServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.teams = entity;
        teamsServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(teamsServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        teamsServiceStub.retrieve.resolves([foundTeams]);
