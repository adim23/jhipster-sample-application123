    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            hireDateTime: dayjs(currentDate).format(DATE_TIME_FORMAT),
            zonedHireDateTime: dayjs(currentDate).format(DATE_TIME_FORMAT),
      ...
      it('should create a Employee', async () => {
        ...
        const expected = Object.assign(
          {
            hireDateTime: currentDate,
            zonedHireDateTime: currentDate,
