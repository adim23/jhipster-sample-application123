...
describe('Component Tests', () => {
  describe('Files Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      filesServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(filesServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(filesServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(filesServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
