...
class JobHistoryResourceIT {
    ...
    @Test
    @Transactional
    void getAllJobHistoriesByStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where startDate is greater than or equal to DEFAULT_START_DATE
        defaultJobHistoryShouldBeFound("startDate.greaterThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the jobHistoryList where startDate is greater than or equal to UPDATED_START_DATE
        defaultJobHistoryShouldNotBeFound("startDate.greaterThanOrEqual=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where startDate is less than or equal to DEFAULT_START_DATE
        defaultJobHistoryShouldBeFound("startDate.lessThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the jobHistoryList where startDate is less than or equal to SMALLER_START_DATE
        defaultJobHistoryShouldNotBeFound("startDate.lessThanOrEqual=" + SMALLER_START_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByStartDateIsLessThanSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where startDate is less than DEFAULT_START_DATE
        defaultJobHistoryShouldNotBeFound("startDate.lessThan=" + DEFAULT_START_DATE);

        // Get all the jobHistoryList where startDate is less than UPDATED_START_DATE
        defaultJobHistoryShouldBeFound("startDate.lessThan=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where startDate is greater than DEFAULT_START_DATE
        defaultJobHistoryShouldNotBeFound("startDate.greaterThan=" + DEFAULT_START_DATE);

        // Get all the jobHistoryList where startDate is greater than SMALLER_START_DATE
        defaultJobHistoryShouldBeFound("startDate.greaterThan=" + SMALLER_START_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllJobHistoriesByEndDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where endDate is greater than or equal to DEFAULT_END_DATE
        defaultJobHistoryShouldBeFound("endDate.greaterThanOrEqual=" + DEFAULT_END_DATE);

        // Get all the jobHistoryList where endDate is greater than or equal to UPDATED_END_DATE
        defaultJobHistoryShouldNotBeFound("endDate.greaterThanOrEqual=" + UPDATED_END_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByEndDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where endDate is less than or equal to DEFAULT_END_DATE
        defaultJobHistoryShouldBeFound("endDate.lessThanOrEqual=" + DEFAULT_END_DATE);

        // Get all the jobHistoryList where endDate is less than or equal to SMALLER_END_DATE
        defaultJobHistoryShouldNotBeFound("endDate.lessThanOrEqual=" + SMALLER_END_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByEndDateIsLessThanSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where endDate is less than DEFAULT_END_DATE
        defaultJobHistoryShouldNotBeFound("endDate.lessThan=" + DEFAULT_END_DATE);

        // Get all the jobHistoryList where endDate is less than UPDATED_END_DATE
        defaultJobHistoryShouldBeFound("endDate.lessThan=" + UPDATED_END_DATE);
    }

    @Test
    @Transactional
    void getAllJobHistoriesByEndDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        jobHistoryRepository.saveAndFlush(jobHistory);

        // Get all the jobHistoryList where endDate is greater than DEFAULT_END_DATE
        defaultJobHistoryShouldNotBeFound("endDate.greaterThan=" + DEFAULT_END_DATE);

        // Get all the jobHistoryList where endDate is greater than SMALLER_END_DATE
        defaultJobHistoryShouldBeFound("endDate.greaterThan=" + SMALLER_END_DATE);
    }
