...
public class TaskCriteria implements Serializable, Criteria {
    ...
    private LongFilter percentCompleted;
    ...
    public LongFilter getPercentCompleted() {
        return percentCompleted;
    }

    public LongFilter percentCompleted() {
        if (percentCompleted == null) {
            percentCompleted = new LongFilter();
        }
        return percentCompleted;
    }

    public void setPercentCompleted(LongFilter percentCompleted) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, startDate, endDate, percentCompleted, dependsOnId, dependentsId, jobId, distinct);
    }
