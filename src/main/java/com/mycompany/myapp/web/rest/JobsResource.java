...
import com.mycompany.myapp.service.JobsQueryService;
...
public class JobsResource {
     ...
     */
    @GetMapping("/jobs")
    public ResponseEntity<List<Jobs>> getAllJobs(JobsCriteria criteria, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
