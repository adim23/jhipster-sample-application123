...
export default class CitizensRelations extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllCitizensRelationss();
  }
  ...
  public retrieveAllCitizensRelationss(): void {
  ...
  public prepareRemove(instance: ICitizensRelations): void {
  ...
  public removeCitizensRelations(): void {
    this.citizensRelationsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('jhipsterSampleApplication123App.citizensRelations.deleted', { param: this.removeId });
