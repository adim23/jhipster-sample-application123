  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplication123App.region.home.createOrEditLabel"
          data-cy="RegionCreateUpdateHeading"
          v-text="$t('jhipsterSampleApplication123App.region.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplication123App.region.regionName')" for="region-regionName"
              >Region Name</label
            >
            <input
              type="text"
            ...
            <div v-if="$v.region.regionName.$anyDirty && $v.region.regionName.$invalid">
              <small class="form-text text-danger" v-if="!$v.region.regionName.required" v-text="$t('entity.validation.required')">
