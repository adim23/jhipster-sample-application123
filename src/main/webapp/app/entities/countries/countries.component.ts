...
export default class Countries extends Vue {
  ...
  public retrieveAllCountriess(): void {
  ...
  public prepareRemove(instance: ICountries): void {
  ...
  public removeCountries(): void {
    this.countriesService()
      ...
      .then(() => {
        const message = this.$t('jhipsterSampleApplication123App.countries.deleted', { param: this.removeId });
