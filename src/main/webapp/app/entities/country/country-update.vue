  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterSampleApplication123App.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="$t('jhipsterSampleApplication123App.country.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplication123App.country.countryName')" for="country-countryName"
              >Country Name</label
            >
            <input
              type="text"
              ...
              required
            />
            <div v-if="$v.country.countryName.$anyDirty && $v.country.countryName.$invalid">
              <small class="form-text text-danger" v-if="!$v.country.countryName.required" v-text="$t('entity.validation.required')">
                This field is required.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplication123App.country.region')" for="country-region"
              >Region</label
            >
