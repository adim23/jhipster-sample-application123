...
export default class Companies extends Vue {
  ...
  public retrieveAllCompaniess(): void {
  ...
  public prepareRemove(instance: ICompanies): void {
  ...
  public removeCompanies(): void {
    this.companiesService()
      ...
      .then(() => {
        const message = this.$t('jhipsterSampleApplication123App.companies.deleted', { param: this.removeId });
